...
{
    int src,dest,wt;
    cout<<"Enter source Vertex Destination Vertex Weight of Edge : ";
    cin>>src>>dest>>wt;
    wt*=-1;             //Multiplying weight with -1 to convert it into a problem of minimum spanning tree
