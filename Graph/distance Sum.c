...
struct AdjList
{
    struct AdjListNode *head;  // polong long inter to head node of list
};
...
// A utility function used to prlong long int the solution
...
long long int dijkstra(struct Graph* graph, long long int src,long long int dest)
{
...
int main()
{
    ...
    while(t--)
    {
        ...
        long long int count=0,wt;
        long long int src=0,dest=1;
        for(int i=0;i<3;i++)
        {
            src=0;
            dest=count+1;
